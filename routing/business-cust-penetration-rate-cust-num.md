---
id: routing-business-cust-penetration-rate-cust-num
kind: routing
domain: business
title: 经营分析-客数指标路由规则
tags:
...
判断为客数专项报告时，固定走 `qdm-cmr-cli report business`，固定 `--indicator 客数`。
...
- 不得路由到客数渗透率根指标、19点前客数、销售额、品效或活跃供应商数专项；泛经营问题继续走 `routing/business-overview.md`。
