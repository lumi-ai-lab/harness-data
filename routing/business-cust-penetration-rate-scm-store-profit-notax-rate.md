---
id: routing-business-cust-penetration-rate-scm-store-profit-notax-rate
kind: routing
domain: business
title: 经营分析-供应链毛利率指标路由规则
tags:
  - routing
  - business-report
...
判断为供应链毛利率专项报告时，固定走 `qdm-cmr-cli report business`，固定 `--indicator 供应链毛利率`。
...
- 不得路由到全链路毛利率、门店毛利率、供应链毛利额、销售额、客数、品效或活跃供应商数专项；泛经营问题继续走 `routing/business-overview.md`。
