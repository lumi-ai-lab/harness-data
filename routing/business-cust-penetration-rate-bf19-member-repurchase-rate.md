---
id: routing-business-cust-penetration-rate-bf19-member-repurchase-rate
kind: routing
domain: business
title: 经营分析-19点前复购率指标路由规则
tags:
  - routing
  - business-report
...
判断为 19点前复购率专项报告时，固定走 `qdm-cmr-cli report business`，固定 `--indicator 19点前复购率`。
...
- 不得路由到19点前客数、19点前PI值、客数、客数渗透率、销售额、品效或活跃供应商数专项；泛经营问题继续走 `routing/business-overview.md`。
