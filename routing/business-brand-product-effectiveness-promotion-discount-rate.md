---
id: routing-business-brand-product-effectiveness-promotion-discount-rate
kind: routing
domain: business
title: 经营分析-促销折扣率指标路由规则
tags:
  - routing
  - business-report
...
判断为促销折扣率专项报告时，固定走 `qdm-cmr-cli report business`，固定 `--indicator 促销折扣率`。
...
- 不得路由到品效、定价毛利率、预期毛利率、出库折让率、时段折扣率、损耗率或商品订购渗透率专项；泛经营问题继续走 `routing/business-overview.md`。
