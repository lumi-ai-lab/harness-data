...
def build_context(prompt: str, project_dir: Path, harness_dir: Path, date_info: dict[str, object]) -> str:
    ...
    parts.append('"$QDM_CMR_CLI" report business overview <cli_filter>\n')
    parts.append('"$QDM_CMR_CLI" report business indicators <cli_filter>\n')
    parts.append('"$QDM_CMR_CLI" report business tree --values <cli_filter>\n')
    parts.append('"$QDM_CMR_CLI" report business area <cli_filter>\n')
    parts.append('"$QDM_CMR_CLI" report business category <cli_filter>\n')
    parts.append('"$QDM_CMR_CLI" report business trend <cli_filter>\n')
    parts.append("```\n")
