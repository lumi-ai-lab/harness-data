...
| Ordinary prompt creates durable state | Structured hooks default to on-demand; only explicit/continuation prompts build context | Implemented for structured callers |
