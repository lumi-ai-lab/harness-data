...
- `--context-file`, `--plugin-root`, `--data-root`, `--workspace-root`,
...
golden path. Structured CLI commands route wiki resources through `pluginRoot`,
mutable configuration/runtime through `dataRoot`, and session writes through
