...
func TestRewriteGatedMetricCommandsCoversProtectedDataCommands(t *testing.T) {
	for _, subcommand := range []string{"analysis validate", "analysis preview", "analysis execute", "analysis total"} {
...
func TestMetricCommandDetectionCoversOnlyProtectedCommands(t *testing.T) {
	for _, subcommand := range []string{"analysis validate", "analysis preview", "analysis execute", "analysis total", "auth describe"} {
