...
func TestValidateFindsMissingDuplicateInvalidAndBadPath(t *testing.T) {
	docs := []harness.Document{
		...
		{ID: "playbook-no-template", Kind: "playbook", Domain: "member", Path: "playbooks/member/no-template.md"},
		{ID: "playbook-bad-template", Kind: "playbook", Domain: "member", Path: "playbooks/member/bad-template.md", Template: "member-overview-report.md"},
		{ID: "playbook-index-template", Kind: "playbook_index", Domain: "member", Path: "playbooks/member/index-template.md", Template: "templates/member-overview-report.md"},
	}
