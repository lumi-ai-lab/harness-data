...
func TestBusinessBrandProductEffectivenessContextSelectsDrillPlaybook(t *testing.T) {
	...
	if got["playbooks/business/default-overview.md"] {
...
func TestBusinessOverviewStillSelectsDefaultPlaybook(t *testing.T) {
	...
	if got["playbooks/business/brand-product-effectiveness.md"] {
		t.Fatalf("unexpected brand product playbook in %#v", response.ContextFiles)
	}
	if got["playbooks/business/cust-penetration-rate/cust-penetration-rate.md"] {
...
func TestBusinessCustPenetrationRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/cust-penetration-rate.md",
		"routing/business-cust-penetration-rate-cust-penetration-rate.md",
		"playbooks/business/cust-penetration-rate/cust-penetration-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
...
func TestBusinessBf19SaleRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/bf19-sale-rate.md",
		"routing/business-cust-penetration-rate-bf19-sale-rate.md",
		"playbooks/business/cust-penetration-rate/bf19-sale-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/cust-penetration-rate/sale-amt.md"] {
...
func TestBusinessBf19SaleWeightContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/bf19-sale-weight.md",
		"routing/business-cust-penetration-rate-bf19-sale-weight.md",
		"playbooks/business/cust-penetration-rate/bf19-sale-weight.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/cust-penetration-rate/bf19-sale-rate.md"] {
...
func TestBusinessSatisfiedRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/satisfied-rate.md",
		"routing/business-cust-penetration-rate-satisfied-rate.md",
		"playbooks/business/cust-penetration-rate/satisfied-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/cust-penetration-rate/bf19-sale-weight.md"] {
...
func TestBusinessCustNumContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/cust-num.md",
		"routing/business-cust-penetration-rate-cust-num.md",
		"playbooks/business/cust-penetration-rate/cust-num.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
...
func TestBusinessBf19CustNumContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/bf19-cust-num.md",
		"routing/business-cust-penetration-rate-bf19-cust-num.md",
		"playbooks/business/cust-penetration-rate/bf19-cust-num.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/cust-penetration-rate/cust-num.md"] {
...
func TestBusinessBf19CategoryStoreCustRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/bf19-category-store-cust-rate.md",
		"routing/business-cust-penetration-rate-bf19-category-store-cust-rate.md",
		"playbooks/business/cust-penetration-rate/bf19-category-store-cust-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/cust-penetration-rate/bf19-cust-num.md"] {
...
func TestBusinessBf19MemberRepurchaseRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/bf19-member-repurchase-rate.md",
		"routing/business-cust-penetration-rate-bf19-member-repurchase-rate.md",
		"playbooks/business/cust-penetration-rate/bf19-member-repurchase-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/cust-penetration-rate/bf19-category-store-cust-rate.md"] {
...
func TestBusinessPerCustAmtContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/per-cust-amt.md",
		"routing/business-cust-penetration-rate-per-cust-amt.md",
		"playbooks/business/cust-penetration-rate/per-cust-amt.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
...
func TestBusinessBf19PerCustAmtContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/bf19-per-cust-amt.md",
		"routing/business-cust-penetration-rate-bf19-per-cust-amt.md",
		"playbooks/business/cust-penetration-rate/bf19-per-cust-amt.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/cust-penetration-rate/per-cust-amt.md"] {
...
func TestBusinessBf19AvgPieceNumContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/bf19-avg-piece-num.md",
		"routing/business-cust-penetration-rate-bf19-avg-piece-num.md",
		"playbooks/business/cust-penetration-rate/bf19-avg-piece-num.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/cust-penetration-rate/bf19-per-cust-amt.md"] {
...
func TestBusinessBf19PerPieceAmtContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/bf19-per-piece-amt.md",
		"routing/business-cust-penetration-rate-bf19-per-piece-amt.md",
		"playbooks/business/cust-penetration-rate/bf19-per-piece-amt.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/cust-penetration-rate/bf19-avg-piece-num.md"] {
...
func TestBusinessFullLinkStoreProfitNotaxRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/full-link-store-profit-notax-rate.md",
		"routing/business-cust-penetration-rate-full-link-store-profit-notax-rate.md",
		"playbooks/business/cust-penetration-rate/full-link-store-profit-notax-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
...
func TestBusinessProfitRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/profit-rate.md",
		"routing/business-cust-penetration-rate-profit-rate.md",
		"playbooks/business/cust-penetration-rate/profit-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/cust-penetration-rate/full-link-store-profit-notax-rate.md"] {
...
func TestBusinessScmStoreProfitNotaxRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/scm-store-profit-notax-rate.md",
		"routing/business-cust-penetration-rate-scm-store-profit-notax-rate.md",
		"playbooks/business/cust-penetration-rate/scm-store-profit-notax-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/cust-penetration-rate/profit-rate.md"] {
...
func TestBusinessFullLinkStoreProfitAmtNotaxContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/full-link-store-profit-amt-notax.md",
		"routing/business-cust-penetration-rate-full-link-store-profit-amt-notax.md",
		"playbooks/business/cust-penetration-rate/full-link-store-profit-amt-notax.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
...
func TestBusinessProfitAmtContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/profit-amt.md",
		"routing/business-cust-penetration-rate-profit-amt.md",
		"playbooks/business/cust-penetration-rate/profit-amt.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/cust-penetration-rate/full-link-store-profit-amt-notax.md"] {
...
func TestBusinessScmStoreProfitAmtNotaxContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/cust-penetration-rate/scm-store-profit-amt-notax.md",
		"routing/business-cust-penetration-rate-scm-store-profit-amt-notax.md",
		"playbooks/business/cust-penetration-rate/scm-store-profit-amt-notax.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/cust-penetration-rate/profit-amt.md"] {
...
func TestBusinessPrePriceProfitRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/brand-product-effectiveness/pre-price-profit-rate.md",
		"routing/business-brand-product-effectiveness-pre-price-profit-rate.md",
		"playbooks/business/brand-product-effectiveness/pre-price-profit-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
...
func TestBusinessPreProfitRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/brand-product-effectiveness/pre-profit-rate.md",
		"routing/business-brand-product-effectiveness-pre-profit-rate.md",
		"playbooks/business/brand-product-effectiveness/pre-profit-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/brand-product-effectiveness/pre-price-profit-rate.md"] {
...
func TestBusinessScmPromotionTotalRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/brand-product-effectiveness/scm-promotion-total-rate.md",
		"routing/business-brand-product-effectiveness-scm-promotion-total-rate.md",
		"playbooks/business/brand-product-effectiveness/scm-promotion-total-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/brand-product-effectiveness/pre-profit-rate.md"] {
...
func TestBusinessHourDiscountRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/brand-product-effectiveness/hour-discount-rate.md",
		"routing/business-brand-product-effectiveness-hour-discount-rate.md",
		"playbooks/business/brand-product-effectiveness/hour-discount-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/brand-product-effectiveness/promotion-discount-rate.md"] {
...
func TestBusinessPromotionDiscountRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/brand-product-effectiveness/promotion-discount-rate.md",
		"routing/business-brand-product-effectiveness-promotion-discount-rate.md",
		"playbooks/business/brand-product-effectiveness/promotion-discount-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/brand-product-effectiveness/hour-discount-rate.md"] {
...
func TestBusinessOrderArticleRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/brand-product-effectiveness/order-article-rate.md",
		"routing/business-brand-product-effectiveness-order-article-rate.md",
		"playbooks/business/brand-product-effectiveness/order-article-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
...
func TestBusinessOrderStoresContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/brand-product-effectiveness/order-stores.md",
		"routing/business-brand-product-effectiveness-order-stores.md",
		"playbooks/business/brand-product-effectiveness/order-stores.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/brand-product-effectiveness/order-article-rate.md"] {
...
func TestBusinessStoreCanOrdersContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/brand-product-effectiveness/store-can-orders.md",
		"routing/business-brand-product-effectiveness-store-can-orders.md",
		"playbooks/business/brand-product-effectiveness/store-can-orders.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/brand-product-effectiveness/order-stores.md"] {
...
func TestBusinessPriceIndexContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/brand-product-effectiveness/price-index.md",
		"routing/business-brand-product-effectiveness-price-index.md",
		"playbooks/business/brand-product-effectiveness/price-index.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
...
func TestBusinessPurchasePriceIndexContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/brand-product-effectiveness/purchase-price-index.md",
		"routing/business-brand-product-effectiveness-purchase-price-index.md",
		"playbooks/business/brand-product-effectiveness/purchase-price-index.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/brand-product-effectiveness/price-index.md"] {
...
func TestBusinessLostRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/brand-product-effectiveness/lost-rate.md",
		"routing/business-brand-product-effectiveness-lost-rate.md",
		"playbooks/business/brand-product-effectiveness/lost-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
...
func TestBusinessActiveVenderNumContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/active-vender-num/active-vender-num.md",
		"routing/business-active-vender-num-active-vender-num.md",
		"playbooks/business/active-vender-num/active-vender-num.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
...
func TestBusinessCentralInstockRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/active-vender-num/central-instock-rate.md",
		"routing/business-active-vender-num-central-instock-rate.md",
		"playbooks/business/active-vender-num/central-instock-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/active-vender-num/active-vender-num.md"] {
...
func TestBusinessThreeRateScoreContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/active-vender-num/three-rate-score.md",
		"routing/business-active-vender-num-three-rate-score.md",
		"playbooks/business/active-vender-num/three-rate-score.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
...
func TestBusinessVendorAccuracyRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/active-vender-num/vendor-accuracy-rate.md",
		"routing/business-active-vender-num-vendor-accuracy-rate.md",
		"playbooks/business/active-vender-num/vendor-accuracy-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/active-vender-num/three-rate-score.md"] {
...
func TestBusinessVendorIntimeRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/active-vender-num/vendor-intime-rate.md",
		"routing/business-active-vender-num-vendor-intime-rate.md",
		"playbooks/business/active-vender-num/vendor-intime-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/active-vender-num/vendor-accuracy-rate.md"] {
...
func TestBusinessVendorQualificationRateContextSelectsMetricPlaybook(t *testing.T) {
	...
	for _, want := range []string{
		"spec/business/active-vender-num/vendor-qualification-rate.md",
		"routing/business-active-vender-num-vendor-qualification-rate.md",
		"playbooks/business/active-vender-num/vendor-qualification-rate.md",
	} {
		if !got[want] {
			t.Fatalf("missing %s in %#v", want, response.ContextFiles)
		}
	...
	if got["playbooks/business/active-vender-num/vendor-intime-rate.md"] {
...
func TestClaudeHookSelectsBrandProductEffectivenessTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/brand-product-effectiveness.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/default-overview.md`)) {
...
func TestClaudeHookSelectsCustPenetrationRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/cust-penetration-rate.md"`,
...
func TestClaudeHookSelectsSaleAmtTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/sale-amt.md"`,
...
func TestClaudeHookSelectsBf19SaleRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/bf19-sale-rate.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/cust-penetration-rate/sale-amt.md`)) {
...
func TestClaudeHookSelectsBf19SaleWeightTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/bf19-sale-weight.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/cust-penetration-rate/bf19-sale-rate.md`)) {
...
func TestClaudeHookSelectsSatisfiedRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/satisfied-rate.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/cust-penetration-rate/bf19-sale-weight.md`)) {
...
func TestClaudeHookSelectsCustNumTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/cust-num.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/cust-penetration-rate/bf19-cust-num.md`)) {
...
func TestClaudeHookSelectsBf19CustNumTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/bf19-cust-num.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/cust-penetration-rate/cust-num.md`)) {
...
func TestClaudeHookSelectsBf19CategoryStoreCustRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/bf19-category-store-cust-rate.md"`,
...
func TestClaudeHookSelectsBf19MemberRepurchaseRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/bf19-member-repurchase-rate.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/cust-penetration-rate/bf19-category-store-cust-rate.md`)) {
...
func TestClaudeHookSelectsPerCustAmtTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/per-cust-amt.md"`,
...
func TestClaudeHookSelectsBf19PerCustAmtTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/bf19-per-cust-amt.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/cust-penetration-rate/per-cust-amt.md`)) {
...
func TestClaudeHookSelectsBf19AvgPieceNumTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/bf19-avg-piece-num.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/cust-penetration-rate/bf19-per-cust-amt.md`)) {
...
func TestClaudeHookSelectsBf19PerPieceAmtTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/bf19-per-piece-amt.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/cust-penetration-rate/bf19-avg-piece-num.md`)) {
...
func TestClaudeHookSelectsFullLinkStoreProfitNotaxRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/full-link-store-profit-notax-rate.md"`,
...
func TestClaudeHookSelectsProfitRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/profit-rate.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/cust-penetration-rate/full-link-store-profit-notax-rate.md`)) {
...
func TestClaudeHookSelectsScmStoreProfitNotaxRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/scm-store-profit-notax-rate.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/cust-penetration-rate/profit-rate.md`)) {
...
func TestClaudeHookSelectsFullLinkStoreProfitAmtNotaxTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/full-link-store-profit-amt-notax.md"`,
...
func TestClaudeHookSelectsProfitAmtTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/profit-amt.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/cust-penetration-rate/full-link-store-profit-amt-notax.md`)) {
...
func TestClaudeHookSelectsScmStoreProfitAmtNotaxTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/cust-penetration-rate/scm-store-profit-amt-notax.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/cust-penetration-rate/profit-amt.md`)) {
...
func TestClaudeHookSelectsPrePriceProfitRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/brand-product-effectiveness/pre-price-profit-rate.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/brand-product-effectiveness.md`)) {
...
func TestClaudeHookSelectsPreProfitRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/brand-product-effectiveness/pre-profit-rate.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/brand-product-effectiveness/pre-price-profit-rate.md`)) {
...
func TestClaudeHookSelectsScmPromotionTotalRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/brand-product-effectiveness/scm-promotion-total-rate.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/brand-product-effectiveness/pre-profit-rate.md`)) {
...
func TestClaudeHookSelectsHourDiscountRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/brand-product-effectiveness/hour-discount-rate.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/brand-product-effectiveness/promotion-discount-rate.md`)) {
...
func TestClaudeHookSelectsPromotionDiscountRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/brand-product-effectiveness/promotion-discount-rate.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/brand-product-effectiveness/hour-discount-rate.md`)) {
...
func TestClaudeHookSelectsOrderArticleRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/brand-product-effectiveness/order-article-rate.md"`,
...
func TestClaudeHookSelectsOrderStoresTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/brand-product-effectiveness/order-stores.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/brand-product-effectiveness/order-article-rate.md`)) {
...
func TestClaudeHookSelectsStoreCanOrdersTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/brand-product-effectiveness/store-can-orders.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/brand-product-effectiveness/order-stores.md`)) {
...
func TestClaudeHookSelectsPriceIndexTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/brand-product-effectiveness/price-index.md"`,
...
func TestClaudeHookSelectsPurchasePriceIndexTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/brand-product-effectiveness/purchase-price-index.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/brand-product-effectiveness/price-index.md`)) {
...
func TestClaudeHookSelectsLostRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/brand-product-effectiveness/lost-rate.md"`,
...
func TestClaudeHookSelectsActiveVenderNumTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/active-vender-num/active-vender-num.md"`,
...
func TestClaudeHookSelectsCentralInstockRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/active-vender-num/central-instock-rate.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/active-vender-num/active-vender-num.md`)) {
...
func TestClaudeHookSelectsThreeRateScoreTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/active-vender-num/three-rate-score.md"`,
...
func TestClaudeHookSelectsVendorAccuracyRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/active-vender-num/vendor-accuracy-rate.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/active-vender-num/three-rate-score.md`)) {
...
func TestClaudeHookSelectsVendorIntimeRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/active-vender-num/vendor-intime-rate.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/active-vender-num/vendor-accuracy-rate.md`)) {
...
func TestClaudeHookSelectsVendorQualificationRateTemplate(t *testing.T) {
	...
	for _, want := range []string{
		`"selected_playbook": "playbooks/business/active-vender-num/vendor-qualification-rate.md"`,
	...
	if bytes.Contains(data, []byte(`playbooks/business/active-vender-num/vendor-intime-rate.md`)) {
