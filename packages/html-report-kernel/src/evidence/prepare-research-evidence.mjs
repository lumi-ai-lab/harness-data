...
import { semanticQueryShape, applyQueryPatch } from "../data/fetch-explore.mjs";
...
import { persistEditorSourceInventory } from "../editor/source-inventory-cache.mjs";
import {
...
export { rowsSha256 } from "../data/fetch-entry.mjs";
